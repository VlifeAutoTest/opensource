package com.jhopesoft.framework.core.dataobject.filter;
...
public class SqlModuleFilter implements Serializable {
	...
	private String getThisFilterSql() {
		...
		if (equalsMethod != null) {
			if (equalsMethod.equals(EQUALSMETHOD_YEAR))
				...
				return "( year(" + getAs() + primarykey + ")=" + equalsValue.substring(0, 4) + " and " + "month("
						+ getAs() + primarykey + ") >= " + ((jd - 1) * 3 + 1) + " and month(" + getAs() + primarykey
						+ ") <= " + ((jd - 1) * 3 + 3) + ")";
			} else if (equalsMethod.equals(EQUALSMETHOD_YMD)) {
				return "( year(" + getAs() + primarykey + ")=" + equalsValue.substring(0, 4) + " and " + "month("
						+ getAs() + primarykey + ") = " + equalsValue.substring(5, 7) + " and day(" + getAs()
						+ primarykey + ") = " + equalsValue.substring(8, 10) + ")";
	...
	public String toString() {
		return "SqlModuleFilter [text=" + text + ", moduleName=" + moduleName + ", tableAsName=" + tableAsName
				+ ", primarykey=" + primarykey + ", nameField=" + nameField + ", fieldtitle=" + fieldtitle
				+ ", equalsValue=" + equalsValue + ", equalsMethod=" + equalsMethod + ", isCodeLevel=" + isCodeLevel
				+ "]";
	}
